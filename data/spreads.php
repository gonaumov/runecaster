...
$spreads[] = array(
   ...
   "spread_cells" => array("t2","t4","t5","t6","t8")
);
...
$spreads[] = array(
   ...
   "spread_cells" => array("t2","t4","t6","t8")
);
...
$spreads[] = array(
   ...
   "spred_description" => "This spread is used for daily casts. It provides a precise answer to a conflict or problem. It can give you the general overview for the day or an answer to a specific question.",
    "spread_cells" => array("t5")
);

$json = json_encode($spreads,JSON_PRETTY_PRINT);
file_put_contents("spreads.json", $json);
echo "\nAll done!\n";
?>
